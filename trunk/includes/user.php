...
Class User extends Database {   
	...
	function charuidToName($uid){
		$name = $this->first("SELECT `name` FROM `characters`.`characters` WHERE `guid`='$uid'"); 
        ...
        ?>
			<form name="" method="POST" action="">
                ...
                <div style='position: relative; top: 0px;'>
					<small>Логин <span style='padding-left: 51px;'>Пароль</span></small>
				</div>
			</form>
			<br>
			Для входа используется ваш логин и пароль от игры.
        <?php
        }      
	}
